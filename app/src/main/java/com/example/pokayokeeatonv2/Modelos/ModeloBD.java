...
public class ModeloBD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase BD){
        ...
        BD.execSQL("create table Etiqueta (IDEtiqueta INTEGER PRIMARY KEY autoincrement NOT NULL, CodigoBarras Text, etiqueta2D Text, etiquetaAIAG Text ,etiquetaLineSet Text, fecha Text, fechaInsercion Text, Estado INTEGER)");
        BD.execSQL("create table Registros(IDRegistro INTEGER PRIMARY KEY autoincrement NOT NULL, CodigoBarras Text, etiqueta2D Text, etiquetaAIAG Text ,etiquetaLineSet Text, fecha Text, fechaInsercion Text)");
    }
    @Override
